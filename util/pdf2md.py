...
def pdf2md(input_dir, output_dir, server_url="http://127.0.0.1:30000"):
    pdf_suffixes = ["pdf"]
    image_suffixes = ["png", "jpeg", "jp2", "webp", "gif", "bmp", "jpg"]

    doc_path_list = []
    for doc_path in Path(input_dir).glob('*'):
    ...
    parse_doc(doc_path_list, output_dir, backend="vlm-http-client", server_url=server_url)  # faster(client).
